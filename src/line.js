...
Line.prototype = {
    ...
    translate: function (vector) {
        ...
        return Line.create([
        this.anchor.elements[0] + V[0], this.anchor.elements[1] + V[1], this.anchor.elements[2] + (V[2] || 0)], this.direction);
    },
    ...
    pointClosestTo: function (obj) {
        if (obj.start && obj.end) {
            ...
            P[0] + V.elements[0] * k, P[1] + V.elements[1] * k, (P[2] || 0) + V.elements[2] * k]);
        }
    },
    ...
    rotate: function (t, line) {
        ...
        var x = A1 - C1,
            ...
            z = A3 - C3;
        return Line.create([
        C1 + R[0][0] * x + R[0][1] * y + R[0][2] * z, C2 + R[1][0] * x + R[1][1] * y + R[1][2] * z, C3 + R[2][0] * x + R[2][1] * y + R[2][2] * z], [
        R[0][0] * D[0] + R[0][1] * D[1] + R[0][2] * D[2], R[1][0] * D[0] + R[1][1] * D[1] + R[1][2] * D[2], R[2][0] * D[0] + R[2][1] * D[1] + R[2][2] * D[2]]);
    },
    ...
    setVectors: function (anchor, direction) {
        ...
        direction.elements[0] / mod, direction.elements[1] / mod, direction.elements[2] / mod]);
        return this;
    }
};
